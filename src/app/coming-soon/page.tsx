...
export const metadata: Metadata = {
  title: "Coming Soon | C.P. McDonough Construction Corp",
...
const ComingSoonPage = () => {
  return (
    <>
      <section className="relative z-10 pb-16 pt-36 text-black md:pb-20 lg:pb-28 lg:pt-[180px]">
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  We are currently working on this page. Please check back
                  later.
                </p>
                <Link
                  href="/"
        ...
        <div className="absolute bottom-0 left-0 z-[-1] hidden sm:block">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#00a261" stopOpacity="0" />
                <stop offset="1" stopColor="#00a261" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#00a261" />
                <stop offset="1" stopColor="#00a261" stopOpacity="0" />
              </linearGradient>
              <linearGradient
