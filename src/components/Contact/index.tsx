          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <div className="mb-7">
                ...
                <p className="mb-3 block text-lg font-medium text-dark dark:text-white">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <div className="mb-7">
                ...
                <p className=" block text-lg font-medium text-dark dark:text-white">
                  8 Puzzle Lane
                </p>
                <p className="mb-3 block text-lg font-medium text-dark dark:text-white">
                  Newton, NH 03858
              ...
              <div className="md:flex">
                <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl md:mr-2 lg:text-2xl xl:text-3xl">
                  {`Get a quote: `}
                </h2>

                <a
                  href="tel:978-375-7001"
                  className="mb-3 text-2xl font-bold text-black hover:underline dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl"
                >
                  978-375-7001
                </a>
              </div>
